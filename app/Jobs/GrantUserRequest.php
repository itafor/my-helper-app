...
class GrantUserRequest implements ShouldQueue
{
    ...
    {
         Mail::send('emails.grant_user-request', ['help_provider' => $this->help_provider,'main_request'=>$this->main_request, 'request_owner'=>$this->request_owner, 'logistic_partner'=>$this->logistic_partner, 'request_bidding_record'=>$this->request_bidding_record], function ($message) {

    $message->subject('Request Granted');

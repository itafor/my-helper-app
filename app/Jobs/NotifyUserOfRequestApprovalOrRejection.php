...
class NotifyUserOfRequestApprovalOrRejection implements ShouldQueue
{
    ...
    $message->subject($this->request_bidding_record->status == 'Approved' ? 'Request Acceptance Notification':'Request Rejection Notification');

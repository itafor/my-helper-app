                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 content-wrapper">
                        <div class="content-header">
                            <h3 class="text-blue text-center h2-heading">{{ __('Welcome to MyHelperApp where you can receive or provide goods and services for free or at a fee during the lockdown.') }} <span> {{__('We’re here to help you get through the stress of the lockdown. ')}}</span></h3>
